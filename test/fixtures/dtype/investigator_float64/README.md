...
This artifact stores the `tensorcode.tools.investigator.Investigator` architecture configuration and model weights.
...
model = Investigator.from_pretrained("./model")
```
