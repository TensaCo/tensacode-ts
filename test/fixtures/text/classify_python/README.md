...
This artifact stores the `tensorcode.ops.text.classify.Classify` architecture configuration and model weights.
...
```python
from tensorcode.ops.text.classify import Classify
