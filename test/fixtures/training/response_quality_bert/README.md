...
This artifact stores the `tensorcode._internal.response_quality.ResponseQualityAssessor` architecture configuration and model weights.
...
model = ResponseQualityAssessor.from_pretrained("./model")
```
