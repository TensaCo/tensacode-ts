...
This artifact stores the `tensorcode.ops.vec.encode.PatchEncoder` architecture configuration and model weights.
...
```python
from tensorcode.ops.vec.encode import PatchEncoder

model = PatchEncoder.from_pretrained("./model")
```
