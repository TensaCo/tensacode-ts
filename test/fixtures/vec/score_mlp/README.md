...
This artifact stores the `tensorcode.ops.vec.score.Score` architecture configuration and model weights.
...
```python
from tensorcode.ops.vec.score import Score

model = Score.from_pretrained("./model")
```
