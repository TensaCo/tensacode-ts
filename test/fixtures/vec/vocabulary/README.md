...
This artifact stores the `tensorcode.ops.vec.encode.VocabularyEncoder` architecture configuration and model weights.
...
model = VocabularyEncoder.from_pretrained("./model")
```
